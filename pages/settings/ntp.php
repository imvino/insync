...
?>
<div>
    <div class="px-1 my-4">NTP Server IP:<span class="text-gray-400 text-sm pl-2">216.239.35.0</span></div>
    <div class="px-1 mb-2 text-sm font-semibold">Server IP Address</div>
